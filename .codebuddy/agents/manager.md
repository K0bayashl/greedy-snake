...
tools: Read, Task, AskUserQuestion, Glob, Grep
...
调用 designer（使用 glm-4.7 模型，深度思考）：
...
调用 developer（使用 glm-4.7 模型，常规开发）：
...
调用 reviewer（使用 glm-4.7 模型，质量把控）：
...
调用 doc-writer（使用 glm-4.7 模型，简单任务）：
...
### 执行流程
- ✅ 设计评审（designer - glm-4.7）
- ✅ 代码实现（developer - glm-4.7）
- ✅ 代码审查（reviewer - glm-4.7）
- ✅ 功能测试（tester - glm-4.7）
- ✅ 文档更新（doc-writer - glm-4.7）
